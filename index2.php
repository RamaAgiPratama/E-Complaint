              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang Petugas/Admin</h1><h5>Aplikasi Pelaporan Pengaduan Masyarakat</h5>
                  </div>
                  <form class="user" method="post" action="cek_login2.php">
                    ...
                    <hr>
                     <a class="btn btn-info btn-user btn-block" href="index.php"> <font color="white">Logout</font></a>
