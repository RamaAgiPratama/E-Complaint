...
<div class="sidebar-brand-logo rotate-n-20">
          <img src="lapor.png" style="width:50px; height:50px"></i>
        </div>
        <div class="sidebar-brand-text mx-11">E-COMPLAINT</div>
      </a>
      ...
      <!-- Nav Item - Charts -->
       ...
       <li class="nav-item">
        ...
        aria-expanded="true" aria-controls="collpaseTwo">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
       <li class="nav-item">
        ...
        aria-expanded="true" aria-controls="collpaseThree">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h1> <font color="white">Aplikasi Pelaporan Pengaduan Masyarakat</font></h1>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>E-Complaint &copy; Ujikom 2021 Rama Agi Pratama</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
